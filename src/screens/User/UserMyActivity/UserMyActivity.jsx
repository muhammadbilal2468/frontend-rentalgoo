...
const UserMyActivity = () => {
  return (
    <>
      <div className="relative w-full md:w-[400px] m-auto border-x-4 border-primary  font-bold">
        {/* Header */}
          ...
          <div className="grid grid-cols-2 gap-5 justify-between mt-16 mx-4">
            <Link to={"/user/leaseagreements"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Persetujuan Menyewakan</p>
              </div>
            </Link>
            <Link to={"/user/rentalagreements"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Persetujuan Menyewa</p>
              </div>
            </Link>
            <Link to={"/user/isrentingouts"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Sedang Menyewakan</p>
              </div>
            </Link>
            <Link to={"/user/isrentings"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Sedang Menyewa</p>
              </div>
            </Link>
            <Link to={"/user/finishrentowner"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Selesai Menyewakan</p>
              </div>
            </Link>
            <Link to={"/user/finishrentrenter"}>
              <div className="flex flex-col gap-3 justify-center items-center w-full h-32 border border-gray-400 rounded-lg border-b-8 border-b-primary bg-white px-5 cursor-pointer">
                ...
                <p className="text-center text-sm">Selesai Menyewa</p>
              </div>
            </Link>
          </div>
        </div>
