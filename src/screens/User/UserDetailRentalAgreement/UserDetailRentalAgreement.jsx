      ...
      <div className="relative w-full md:w-[400px] m-auto border-x-4 border-primary">
        ...
        <div className="bg-background rounded-b-lg pb-5 min-h-screen">
          ...
          <div className="flex flex-col gap-2 bg-white rounded-lg mx-4">
           ...
           ${(() => {
             if (
               agreementProducts.status === "Diterima, Silahkan Ambil Barang"
             ) {
               return "bg-green-800";
             } else if (
               agreementProducts.status === "Ditolak, Barang Belum Ready"
             ) {
               return "bg-red-800";
             } else {
               return "bg-primary";
            ...
            bg-primary  w-full py-2 rounded-lg`}
            >
...
export default UserDetailRentalAgreement;
