...
import { adminsuggImg } from "../../../assets";
...
const AdminSuggestions = () => {
  ...
  const getSuggestions = async () => {
    try {
      ...
      setTotalIsRentings(resp.data.totalSuggestions);
    } catch (error) {
  ...
  return (
    <>
      <AdminCardHeader
        ...
        desc={"Akses menampilkan semua data saran pengguna"}
      />
      ...
      <div className="bg-white w-full rounded-3xl shadow-md mb-8 bg-white-50">
        ...
        {suggestions.length === 0 ? (
          <NotFoundPage desc={"Belum ada data saran dari pengguna"} />
        ) : (
          <>
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-3">
                      <div className="flex items-center">Saran</div>
                    </th>
                    <th scope="col" className="px-6 py-3">
                      ...
                      >
                        ...
                        <td className="flex items-center gap-2 px-6 py-4">
                          <i
                            ...
                            onClick={() => handleModalDetail(index)}
                          ></i>
                          <AdminModalSuggestion
                            data={data}
                            isOpen={modalDetail[index]}
                            onCancel={() => handleModalDetail(index)}
                          />
                          <i
                          ...
                          <AdminModalConfirm
                            ...
                            title="Hapus Saran"
                            desc="Apakah anda ingin menghapus saran ini ?"
                            cancelText="Batal"
                            confirmText="Hapus"
                          />
                        </td>
