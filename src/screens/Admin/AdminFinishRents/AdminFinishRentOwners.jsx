  ...
  return (
    <>
      <AdminCardHeader
        ...
        title={"Slesai Sewa Oleh Pemilik"}
        desc={"Akses menampilkan semua data selesai sewa oleh pemilik barang"}
      />
      ...
      <div className="bg-white w-full rounded-3xl shadow-md mb-8 bg-white-50">
        ...
        {finishRents.length === 0 ? (
          <NotFoundPage
            desc={"Belum ada data selesai sewa oleh pemilik barang"}
          />
        ) : (
          <>
...
export default AdminFinishRentOwners;
