...
const CardClosestProduct = (props) => {
  return (
    <div
      className="relative max-w-sm h-fit border border-gray-200 rounded-lg shadow-md"
      key={props.data.uuid}
    >
      <p className="absolute text-xs py-1 px-2 bg-secondary text-white font-bold top-0 left-0 border-2 border-secondary rounded-tl-md">
        {props.data.distance}
      </p>
      <p
...
export default CardClosestProduct;
